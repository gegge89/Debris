...
int main(int argc, char *argv[]) {
    ...
    // Label for Headbar
    GtkWidget *label = gtk_label_new("debris - GUIDE");
...
// Load the local file
// Dynamically build the absolute file path
const char *file_path = "/usr/share/debris/doc/manual.pdf";

// Load the file using the absolute path
webkit_web_view_load_uri(webview, g_strconcat("file://", file_path, NULL));
